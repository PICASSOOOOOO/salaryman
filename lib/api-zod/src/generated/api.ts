 ...
 */
export const SolveInterviewQuestionBody = zod.object({
  question: zod.string().describe("The coding interview question text"),
  language: zod
    .string()
    .describe(
  ...
  mode: zod
    .enum(["hint", "solution", "explain", "complexity", "say_it"])
    .describe("Response mode: hint, solution, explain, complexity"),
});

/**
 * @summary Start the browser Discord OAuth login flow
 */
export const BeginDiscordLoginQueryParams = zod.object({
