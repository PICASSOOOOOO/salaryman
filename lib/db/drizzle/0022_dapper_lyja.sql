...
CREATE INDEX "dev_task_notes_task_id_idx" ON "dev_task_notes" USING btree ("dev_task_id");--> statement-breakpoint
CREATE INDEX "dev_tasks_feedback_report_id_idx" ON "dev_tasks" USING btree ("feedback_report_id");--> statement-breakpoint
...
CREATE INDEX "dev_tasks_assigned_to_idx" ON "dev_tasks" USING btree ("assigned_to_user_id");--> statement-breakpoint
