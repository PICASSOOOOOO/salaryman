// ── Resource Catalog (client-side mirror) ────────────────────────────────
// Keep in sync with artifacts/api-server/src/lib/resource-catalog.ts
...
export const ASSAY_OFFICE_X = 6480;
export const ASSAY_OFFICE_Y = 6150;
export const ASSAY_OFFICE_RANGE = 55;
